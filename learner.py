...
dataset = shapes.randomSquares(1000)
model, features = featurize.featurize(dataset)

# normalize the dataset
##TJ May not scale properly for things like radius so consider changing
...
batch_size = 63-9 # image size - window size ##TJ
model = Sequential()
